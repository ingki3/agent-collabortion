...
// change the contract (Director-approved PR) and regenerate. The second
// directive writes enum_values.gen.go (the enums' contract order, which
// oapi-codegen drops), so the CI regenerate-and-diff catches it too (#324 NN2).
//
...
//go:generate sh ../../../scripts/gen_enum_values.sh
package gen
