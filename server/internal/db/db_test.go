...
var prdEnums = map[string][]string{
	...
	"inbox_item_type": {"hitl_request", "lane_blocked", "session_completed", "session_paused", "run_failed", "runtime_offline", "mention", "workdir_gc_blocked", "room_paused", "isolation_confirm"},
