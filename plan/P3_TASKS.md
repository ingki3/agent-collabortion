...
| 항목 | 내용 |
|---|---|
| 상태 | **P3b 마무리 단계(2026-09-07).** 머지: 골든 #108·#113·#120, 스파이크 4c #117, 데몬 #121·#129(T-D5·T-D6), CLI #126(T-C4). 계약: #110·#116·#119·#122·#123·#127·#128. **서버 #124 는 Hermes REQUEST_CHANGES(R1 재개 프롬프트에 HITL 답변 미도달·R2 gc v0.7 미구현) → 재작업 중**(S-36~S-38·S-43·D-16 포함). **웹 #130 Hermes 리뷰 중**. 다음: #124·#130 머지 → T-I3(G6 판정 자료, 스크립트 41_~46_) |
