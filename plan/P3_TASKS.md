...
| 항목 | 내용 |
|---|---|
| 상태 | **G6 2판 재측정 중(2026-09-07).** 1판(#138): PASS 259·FAIL 10, 차단 5(K-7·C-4·S-44·S-45·W-6) + 예산 강제 미발동(D-17·S-48·K-8). 핫픽스 전부 머지: 계약 #133·#143, CLI #134, 서버 #136·#142·#147, 웹 #139, 데몬 #145 → **차단 0**. 2판(T-I3b, `test/g6-remeasure`)이 50_(예산 실기)·(g) 재실행 + E9-10 행 → `plan/G6_REPORT.md §9` → Hermes → `plan/G6_DECISION.md`(컷 3) |
