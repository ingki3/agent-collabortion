...
| 항목 | 내용 |
|---|---|
| 상태 | **✅ G6 통과 — 컷 3 통과(2026-09-07, `plan/G6_DECISION.md`).** 2판(PR #149) PASS 331·FAIL 3·N/A 1, DoD 7행 전부 충족, 대역 0. 남은 S-50(예산 pause 뒤 finish 500 → 콜드 스타트) 은 T-S9a 핫픽스로 P4 첫 서버 작업 전 머지. P4 는 `plan/P4_TASKS.md` |
