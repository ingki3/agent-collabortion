/**
 * 화면 머리(COMPONENTS §8.5) — 제목 + **한 줄 설명** + 오른쪽 행동. 다섯 화면(방·받은 요청·에이전트·
...
export type Screen = "rooms" | "inbox" | "agents" | "computers" | "settings";
...
export const PAGE_COPY: Record<Screen, { title: string; desc: string }> = {
  ...
  computers: { title: "연결된 컴퓨터", desc: "에이전트가 실제로 실행되는 컴퓨터입니다. 연결 상태와 쓰는 중인 방을 봅니다." },
