...
| `colab room messages [--since <id>] [--limit N] [--thread <root_id>] [--work <id>]` | `GET /v1/rooms/{R}/messages` | 메시지 목록(작성자·본문·스레드·시각). 히스토리가 프롬프트에서 잘렸을 때 더 읽는 용도(§8.4 `truncated`) | R3 · R4(옛 `colab session messages` 삭제) |
