#!/usr/bin/env bash
# e2e/p5/ci.sh — CI 가 부르는 한 줄: 스택 기동 → 72~78 · 81 · 82 · 84 · 88 · 90 · 91 · 92 → 표 → 종료. 로컬에서도 같은 명령으로 돈다.
#
...
cd "$E2E_ROOT"
SCRIPTS="${SCRIPTS:-72_scenario_a 73_scenario_b 74_scenario_c 75_scenario_d 76_perf 77_security 78_web_s7 81_observations_commands 82_role_gate 84_cli_allowed_commands 88_room_gate 90_room_read 91_works 92_thread_reply}"
T_ALL0="$(date +%s)"
